    ...
    <div className="max-w-6xl mx-auto animate-in fade-in zoom-in duration-300">
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex gap-2">
           ...
           <button className="bg-blue-600 hover:bg-blue-500 text-white py-2 px-6 rounded-2xl transition-all text-sm font-semibold shadow-lg shadow-blue-500/20">Assign Officer</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="p-2.5 bg-blue-500/10 rounded-xl text-blue-500 mt-1">
                  <Info size={18} />
                </div>
                <div>
              ...
              <div className="pt-6 border-t border-slate-800 space-y-4">
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 flex items-center gap-2"><Calendar size={14} /> Submitted</span>
                  <span className="text-slate-300 font-medium">12 Oct, 2025</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-500 flex items-center gap-2"><User size={14} /> Reported By</span>
                  <span className="text-slate-300 font-medium">Anonymous User</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-6">
             ...
             <div className="grid grid-cols-2 gap-3">
                <button className="bg-slate-800 hover:bg-slate-700 text-white py-2 rounded-xl text-xs font-semibold transition-all">Download Evidence</button>
                <button className="bg-slate-800 hover:bg-slate-700 text-white py-2 rounded-xl text-xs font-semibold transition-all">Verify Status</button>
             </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 h-full min-h-[500px] shadow-sm flex flex-col">
            ...
            <div className="mt-4 p-4 bg-slate-950/50 border border-slate-800 rounded-2xl">
               <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-500 font-bold">COORDINATES</p>
                    <p className="text-sm font-mono text-blue-400">{issue.latitude}, {issue.longitude}</p>
                  </div>
               </div>
            </div>
          </div>
