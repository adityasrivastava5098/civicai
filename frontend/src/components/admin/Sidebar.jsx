...
import { LayoutDashboard, BarChart3, ShieldCheck, Home } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <aside id="sidebar" className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col pt-6 hidden lg:flex">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                isActive
                  ? 'bg-indigo-600/10 text-indigo-500 border border-indigo-500/20 shadow-[0_0_15px_rgba(79,70,229,0.1)]'
